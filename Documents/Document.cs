...
namespace AndriyCo.Shopdesk.Containers.Documents
{
    ...
    public class Document
    {
        ...
        /// <summary>
        /// Сума заокруглення, додана або віднята до суми товарів під час оплати.
        /// </summary>
        /// <remarks>
        /// Використовується в оплатах готівкою, коли потрібно заокруглити суму до порогу заокруглення.<br/>
        /// У випадку додавання суми заокруглення до суми товарів, значення RoundingSum буде додатнім, у випадку віднімання – від’ємним.<br/>
        /// У випадку, коли заокруглення не застосовується, RoundingSum = 0.
        /// </remarks>
        [Money] public double RoundingSum { get; set; }
