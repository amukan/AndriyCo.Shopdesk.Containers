...
|6 - РРО Міні-ФП 81|
|7 - РРО MG-P800TL/MG-T808TL|
|8 - ПРРО Checkbox через Resonance OLE Manager|
|9 - РРО Datecs FP-3141T, FP-T260, FP-320, CMP-10|
|10 - РРО MG-N707TS|
|11 - РРО Exellio FPU-550/FPU-260|
|12 - РРО ICS-810|
|13 - РРО Atol до версії 10 (підтримка припинена)|
|14 - РРО MG-N707TS з прошивкою нумерації типів оплат: Готівка=1, Чек=2, Кредит=3, Картка=4|
|15 - РРО Atol версії 10 (підтримка припинена)|
|16 - РРО AtlasFP.dll з протоколом Krypton|
|17 - РРО MG по протоколу RS232|
|18 - РРО MG по протоколу HTTP|
|19 - РРО LeoCas|
|20 - ПРРО Cashalot|
|21 - РРО Resonance M301/M304|
|22 - ПРРО Checkbox через API|
