...
## <a id="table1">Таблиця 1. Документ ([Document](/blob/main/Documents/Document.cs))
...
## <a id="table2">Таблиця 2. Запис з товаром ([DocumentDetail](/blob/main/Documents/Document.cs))
...
## <a id="table3">Таблиця 3. Запис про знижку або надбавку на суму по товару ([Discount](/blob/main/Documents/Document.cs))
...
## <a id="table4">Таблиця 4. Запис по маркетинговій акції та маркетинговому інструменту, яким задовольняє чек ([MarketingActionRecord](/blob/main/Marketing/MarketingActionRecord.cs))
...
## <a id="table5">Таблиця 5. Запис по відображеному повідомленню від CRM по акціям для клієнта ([MarketingToolRecordDescription](/blob/main/Marketing/MarketingActionRecord.cs))

|Ім'я елементу|Тип даних|Опис|
| :---| :---:| :---|
|Id|UInt32|ID MarketingToolRecord|

## <a id="table6">Таблиця 6. Нумератор типів документів ([DocumentType](/blob/main/Marketing/MarketingActionRecord.cs))
...
## <a id="table7">Таблиця 7. Докладна інформація по банківській транзакції та платіжному терміналу при оплаті карткою ([TransactionInfo](/blob/main/Bank/TransactionInfo.cs))
