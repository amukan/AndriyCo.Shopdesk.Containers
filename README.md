...
> [!NOTE]
> Щоб перевірити створену вами структуру XML контейнера, використовуте **[Сервіс для перевірки структури XML контейнера](https://base2base.com.ua/Shopserver/ContainerTest)**
> Зауважте, що сервіс перевіряє тільки структуру, дані не перевіряються.
