...
|1 - РРО Міні-ФП|
|<span style="color:#999999">2 - РРО Datecs 3530 (застарів, не підтримується в нових версіях)</span>|
|3 - РРО Міні-ФП 6|
|4 - РРО Міні-ФП 54|
|~~5 - РРО Штрих-М~~ (підтримка припинена)|
|6 - РРО Міні-ФП 81|
|<span style="color:#999999">7 - РРО MG-P800TL/MG-T808TL (застарів, не підтримується в нових версіях)</span>|
|8 - ПРРО Checkbox через Resonance OLE Manager|
|<span style="color:#999999">9 - РРО Datecs FP-3141T, FP-T260, FP-320, CMP-10 (протокол OPOS) (застарів, не підтримується в нових версіях)</span>|
|<span style="color:#999999">10 - РРО MG-N707TS (застарів, не підтримується в нових версіях)</span>|
|11 - РРО Exellio FPU-550/FPU-260 (протокол Datecs)|
|12 - РРО ICS-810 (прошивка EP-12)|
|~~13 - РРО Atol до версії 10~~ (підтримка припинена)|
|<span style="color:#999999">14 - РРО MG-N707TS (OLE Server) Ver.2 (з прошивкою нумерації типів оплат: Готівка=1, Чек=2, Кредит=3, Картка=4) (застарів, не підтримується в нових версіях)</span>|
