...
|Ім'я елементу                      |Обов'язковий|Тип даних  	|Опис|
|:---                               |:---:|:---		    |:---|
...
|<sup>*</sup>GoodsItemType          |Byte       |Тип товару. Нумератор [GoodsItemType](/Documents/Document.cs). Ingredient = 1 (Елементарний товар (інгредієнт)), Product = 2 (Виріб), Job = 4 (Робота/послуга)|
